...
export const OBJECT_MOTION_TYPES = ["spin", "path", "drift"];
export const OBJECT_MOTION_GUIDANCE = "Persistent motion is for designs that call for it; one moving element per page is the norm.";
