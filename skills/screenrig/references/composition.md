...
art, hierarchy, and type together. That is the presentable quality bar.
GPT-image-2 is orders of magnitude nicer than a composed still. Local
...
ScreenRig generate is the default (current vendor model is GPT-image-2).
